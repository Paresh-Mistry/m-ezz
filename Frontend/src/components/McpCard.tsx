        ...
        <>
            {filteredCards.length > 0 && (
                filteredCards.map((data) => (
                    <div key={data.id} className="shadow-lg shadow-gray-500/50 border border-slate-200 p-5 rounded-lg w-fit">
                        ...
                        <div className="flex justify-between items-center mt-4">
                            ...
                            <label className="cursor-pointer flex items-center">
                                ...
                                <span className="ms-3 text-sm font-medium"> {isEnabled[data.id] ? "Enabled" : "Disabled"}</span>
                            </label>
                        </div>
                    </div>
                ...
                ||
                <div className="p-4 mb-4 text-sm flex items-center gap-2 rounded-lg dark:bg-gray-800 dark:text-red-400" role="alert">
